...
# Sets the following variables if git is found: GIT_REVISION: The current HEAD
# sha hash GIT_STATE: A description of the working tree, e.g.,
# 1.8.0-48-g6d23f80-dirty GIT_ORIGIN_URL: The origin of the working tree
# GIT_ROOT_URL: The root remote of the working tree GIT_BRANCH: The name of the
# current branch GIT_AUTHORS: A list of all authors in the git history
...
if(EXISTS ${PROJECT_SOURCE_DIR}/.git)
  ...
  if(GIT_FOUND)
    ...
    execute_process(
      ...
      WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
    execute_process(
      COMMAND "${GIT_EXECUTABLE}" config --get remote.root.url
